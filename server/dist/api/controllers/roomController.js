...
let RoomController = class RoomController {
    ...
    joinGame(socket, io, message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const connectedSocketsBeforePlayerJoined = io.sockets.adapter.rooms.get(message.roomId);
            ...
            if (socketRooms.length > 0 ||
                ...
                const connectedSocketsSizeAfterPlayerJoined = io.sockets.adapter.rooms.get(message.roomId).size;

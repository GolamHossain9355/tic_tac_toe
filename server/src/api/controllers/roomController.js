...
var RoomController = exports.RoomController = /** @class */ (function () {
    function RoomController() {
    }
    RoomController.prototype.onConnection = function (socket, io) {
        console.log("New Socket connected to RoomController: ", socket.id);
    };
    RoomController.prototype.joinGame = function (socket, io, message) {
        return __awaiter(this, void 0, void 0, function () {
            var connectedSocketsBeforePlayerJoined, socketRooms, connectedSocketsSizeAfterPlayerJoined;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("new user joining room: " + socket.id, " ", "Message: ", message);
                        connectedSocketsBeforePlayerJoined = io.sockets.adapter.rooms.get(message.roomId);
                        ...
                        if (!(socketRooms.length > 0 ||
                            (connectedSocketsBeforePlayerJoined &&
                                connectedSocketsBeforePlayerJoined.size === 2))) return [3 /*break*/, 1];
                    ...
                    case 2:
                        ...
                        connectedSocketsSizeAfterPlayerJoined = io.sockets.adapter.rooms.get(message.roomId).size;
    ...
    ], RoomController.prototype, "onConnection", null);
    __decorate([

...
var roomController_1 = require("./api/controllers/roomController");
var gameController_1 = require("./api/controllers/gameController");
exports.default = (function (httpServer) {
    ...
    io.on("connection", function (socket) {
        ...
        socket.on("join_game", function (message) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // console.info("Received join_game event with message:", message)
                    return [4 /*yield*/, roomController.joinGame(socket, io, message)];
                    case 1:
                        // console.info("Received join_game event with message:", message)
                        _a.sent();
                        return [2 /*return*/];
        ...
        socket.on("update_game", function (message) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // console.info("Received update_game event with message:", message)
                    return [4 /*yield*/, gameController.updateGame(socket, io, message)];
                    case 1:
                        // console.info("Received update_game event with message:", message)
                        _a.sent();
                        return [2 /*return*/];
        ...
        socket.on("game_win", function (message) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, gameController.gameWin(socket, io, message)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
